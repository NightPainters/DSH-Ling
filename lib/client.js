    ...
    factory: function (require) {
      ...
      function ensureStyle() {
        ...
        tag.textContent =
          ...
          // 只读列表沿用输入框的框(和"底线/规矩"同一视觉规格;习惯栏用它,2026-09-16 尝生要求)
      ...
      function openPersonaEditor(prefill) {
        ...
        function renderHabits(p) {
          ...
          // (2026-09-16 尝生)不再解释"改动需做手术":这一栏是只读的,读者自然明白。
        }
      ...
      function openFeedbackPanel() {
        ...
        function renderTiers(fragOuter) {
          ...
          api('/persona/rules').then(function (r) {
            ...
            var habits = r.habits || [];
            frag.appendChild(blockTitle(she('◈ 习惯(她长出来的 · 需你点头)') + (pending.length ? '(' + pending.length + ' 条待确认)' : '')));
            ...
            // ③ (已撤销)「你也可以提一条习惯等她回应」的入口 —— 2026-09-16 按尝生判断撤掉:
