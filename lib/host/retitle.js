 ...
 *  一条信息量不足的**真实会话标题**换成「D:\某工作目录\license 写入声明<Copyright [年份]」,
 *  「看一下这个文件夹的 D:\某目录\某前缀」换成更短的路径 —— 比原标题更糟。 */
 ...
 * 实锤教训(2026-09-17):批量起名把「用户原则:某某习惯(简要说明)」(conv_id = `user:<类别>-…`)
 * 改成「用户原则:改写成更短的说法」,丢了括注里的理由 —— 合成行不是会话,不参与起名。
 */
